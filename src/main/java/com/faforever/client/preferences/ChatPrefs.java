...
public class ChatPrefs {
  ...
  private static final Map<String, String> LANGUAGE_CHANNELS;

  static {
    LANGUAGE_CHANNELS = new HashMap<>();
    LANGUAGE_CHANNELS.put("fr", "#french");
    LANGUAGE_CHANNELS.put("ru", "#russian");
    LANGUAGE_CHANNELS.put("de", "#german");
  }
